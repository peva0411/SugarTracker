...
namespace SugarTracker.Web.Migrations
{
    ...
    [Migration("20160828184835_userinfo")]
    partial class userinfo
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SugarTracker.Web.Entities.User", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("SugarTracker.Web.Entities.UserPhoneNumber", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SugarTracker.Web.Entities.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SugarTracker.Web.Entities.UserPhoneNumber", b =>
                {
                    b.HasOne("SugarTracker.Web.Entities.User", "User")
